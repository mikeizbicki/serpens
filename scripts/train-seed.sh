...
common="--comment=gamma-$commit- --n_env=128 --batch_size=256 --features_dim=256 --state=overworld*.state --gamma=0.9 --policy=ObjectCnn --task=attack --action_space=zelda-all"
